...
/* ============================================================
   BANCO FINAL · 50 preguntas rotativas
   ============================================================ */
const finalBank = [
  { q:"Comisión del captador arrendador (total):", opts:["10%","20%","30%","50%"], correct:2, why:"Referido 25% + acuerdo 5% = 30% del lado.", whyNot:["Corresponde a arrendatario/vendedor.","No es un tramo vigente.","","Supera tope por lado."] },
  { q:"Comisión del captador arrendatario (total):", opts:["5%","10%","20%","30%"], correct:1, why:"Referido 5% + orden de visita 5% = 10%.", whyNot:["Solo referido, sin orden de visita.","","No existe ese tramo.","Corresponde a arrendador/comprador."] },
  { q:"Desde enero 2026 el referido de comprador es:", opts:["5%","15%","25%","35%"], correct:2, why:"Subió de 5% a 25% para equipararse al arrendador.", whyNot:["Valor pre-2026.","No existe ese tramo.","","No existe ese tramo."] },
  { q:"Registro del referido debe ocurrir:", opts:["Cuando se quiera","Antes del primer contacto formal del cliente con el ejecutor","A fin de mes","No aplica"], correct:1, why:"Timing determina derecho.","whyNot":["No es discrecional.","","Tarde para derecho.","Sí aplica."] },
  { q:"La comisión del TL (7,5% del lado) la paga:", opts:["El captador, de su 30%","TuMatch, desde su propia tajada","El cliente, aparte","Todos los corredores"], correct:1, why:"El TL lo paga TuMatch desde su retención; el captador conserva íntegro su 30%.", whyNot:["Mito: el captador no pierde por tener TL.","","El cliente paga una sola comisión a TuMatch.","No hay descuento cruzado entre corredores."] },
  { q:"Perfil estrella ★ se gatilla cuando:", opts:["Pagas más","El arrendatario tiene toda la documentación cargada en CRM","Se firma arriendo","El corredor tiene estrella"], correct:1, why:"La estrella valida captación completada de arrendatario.", whyNot:["No depende de pago.","","Es previo a firma.","Es del lead, no del corredor."] },
  { q:"Sin estrella, el captador arrendatario cobra:", opts:["10%","Solo el referido del lado (5%)","20%","0%"], correct:1, why:"El 5% extra exige evidencia documental.", whyNot:["Requiere estrella.","","No existe ese tramo.","Cobra al menos el referido."] },
  { q:"Captación CON exclusividad:", opts:["Cualquier corredor","Solo TuMatch comercializa durante el plazo","El dueño vende solo","Nadie ejecuta"], correct:1, why:"Concentra esfuerzo e inversión.", whyNot:["Contradice figura.","","Genera conflicto.","No es figura."] },
  { q:"Duración típica de la exclusividad:", opts:["1 semana","3–6 meses (ajustable)","10 años","Indefinido"], correct:1, why:"Plazo comercial suficiente, renovable.", whyNot:["Insuficiente.","","Abusivo.","No común."] },
  { q:"Captar 'en precio' significa:", opts:["Precio alto","Precio alineado con mercado para comercializar","Rebajar 20%","Regalarla"], correct:1, why:"Evita vacancia/silencio de mercado.", whyNot:["Quema oportunidad.","","Arbitrario.","No aplica."] },
  { q:"Herramienta de tasación está en:", opts:["/contacto","/herramientas/tasacion","/admin","/blog"], correct:1, why:"Ruta oficial del CRM.", whyNot:["No corresponde.","","No es pública.","No es ruta."] },
  { q:"Círculo caliente, conversión típica:", opts:["1%","5%","~33% (1 de 3)","80%"], correct:2, why:"Confianza alta → conversación = oportunidad.", whyNot:["Subestima.","Cifra de tibio.","","Irreal."] },
  { q:"Círculo frío convierte ~:", opts:["33%","10%","2,5% (1 de 40)","50%"], correct:2, why:"Sin relación previa, requiere nurturing largo.", whyNot:["Sería caliente.","Sería tibio.","","Irreal."] },
  { q:"Primer paso con círculo tibio:", opts:["Pedir referido ya","Conversación sin agenda comercial, luego rol","Bloquear","Promoción"], correct:1, why:"Reconexión genuina antes de vender.", whyNot:["Salta paso.","","Pierde relación.","Quema lista."] },
  { q:"Mes 3 del captador:", opts:["Abandonar","Revisar hábitos con TL y ajustar","Bajar comisión","Enojo"], correct:1, why:"Umbral donde el 70% abandona; revisar antes.", whyNot:["Prematuro.","","No aplica.","Improductivo."] },
  { q:"Métrica diaria clave:", opts:["Seguidores","Conversaciones significativas iniciadas","Fotos","Cafés"], correct:1, why:"Conversaciones → oportunidades.", whyNot:["Vanity.","","Irrelevante.","Social, no laboral."] },
  { q:"CRM oficial vive en:", opts:["tumatch.cl","tumatch-leads.vercel.app","Drive","Facebook"], correct:1, why:"Dominio oficial del CRM.", whyNot:["Landing.","","Almacenamiento.","Red social."] },
  { q:"Embudo de captación URL:", opts:["/leads","/embudo-captacion","/dashboard","/admin"], correct:1, why:"Ruta específica del pipeline de captación.", whyNot:["Otro panel.","","No existe.","No pública."] },
  { q:"Sin cargar lead al CRM:", opts:["Nada","Puedes perder comisión si otro registra primero","Se carga solo","Se paga igual"], correct:1, why:"Registro previo = derecho.", whyNot:["Sí importa.","","No es automático.","Sin registro, sin pago."] },
  { q:"Datos personales del cliente:", opts:["Libres","Ley 19.628: accesos restringidos","Públicos","En Facebook"], correct:1, why:"Protección de datos chilena.", whyNot:["Ilegal.","","Ilegal.","Ilegal."] },
  { q:"Exclusividad no es recomendable cuando:", opts:["Tiempo sobra","Hay multicorretaje activo en paralelo (conflicto)","Buena foto","Precio ok"], correct:1, why:"Entrar abierto y formalizar después.", whyNot:["Irrelevante.","","No criterio.","No criterio."] },
  { q:"Cliente +20% sobre tasación:", opts:["Firmar igual","Documentar recomendación, plazo corto o rechazar","Mentir","Pelear"], correct:1, why:"Proteger reputación del corredor.", whyNot:["Quema tiempo.","","Fraude.","Pierde cliente."] },
  { q:"Canon de arriendo sobre-mercado:", opts:["Sin impacto","Vacancia prolongada daña propiedad y confianza","Mejor comisión","Se vende rápido"], correct:1, why:"Tiempo sin arrendar es costo oculto.", whyNot:["Al revés.","","Si no cierra, 0.","Contrario."] },
  { q:"Docs mínimos arrendatario:", opts:["Solo nombre","Cédula, 3 liquidaciones, AFP, Dicom","Solo AFP","Solo carnet"], correct:1, why:"Set para filtro de riesgo.", whyNot:["Insuficiente.","","Incompleto.","Incompleto."] },
  { q:"Renta líquida mínima razonable:", opts:["1×","3× el canon","0,5×","100×"], correct:1, why:"Regla estándar.", whyNot:["Riesgoso.","","Muy bajo.","Absurdo."] },
  { q:"Aval calificado:", opts:["Cualquier amigo","Tercero solvente, responde solidariamente","Decorativo","No existe"], correct:1, why:"Mitiga riesgo en casos marginales.", whyNot:["Debe calificar.","","Es funcional.","Existe."] },
  { q:"Seguro de arriendo cuesta aprox.:", opts:["UF 5/mes","~UF 0,15/mes (≈$6.000)","UF 50","Gratis"], correct:1, why:"Rango típico Chile.", whyNot:["Sobreestima.","","Absurdo.","No."] },
  { q:"WhatsApp oficial TuMatch:", opts:["Ninguno","+56 9 3410 7448","Cualquiera","Solo email"], correct:1, why:"Canal único oficial.", whyNot:["Existe.","","Definido.","Hay WhatsApp."] },
  { q:"Captador a tiempo parcial:", opts:["No acepta","Permitido: trabaja sentado en su escritorio","Obliga full-time","Ilegal"], correct:1, why:"Modelo flexible.", whyNot:["Permitido.","","No obliga.","Legal."] },
  { q:"Tras certificarse, el captador debe:", opts:["Esperar","Contactar por WhatsApp para activar perfil","Pagar","Comprar hostings"], correct:1, why:"Activa CRM + TL.", whyNot:["Proactivo.","","No corresponde.","No corresponde."] },
  { q:"Captador + gestor con TL, lado comprador:", opts:["30%","60% del lado","90%","100%"], correct:1, why:"Tope distribuible con TL.", whyNot:["Incompleto.","","No existe.","No existe."] },
  { q:"TuMatch ofrece principalmente:", opts:["Solo arriendo","Corretaje integral + plataforma digital","Solo obra nueva","Préstamos"], correct:1, why:"Red integral.", whyNot:["Subestima.","","Vertical.","No damos."] },
  { q:"Calculadora hipotecaria sirve para:", opts:["Solo bancos","Mostrar dividendo y capacidad al comprador","Nada","AFP"], correct:1, why:"Anclaje UF al cliente.", whyNot:["Pública.","","Útil.","Nada que ver."] },
  { q:"Cap rate bruto se calcula:", opts:["Valor / arriendo","(Arriendo anual / valor) × 100","Valor × tasa","Pie / valor"], correct:1, why:"Rendimiento bruto anual.", whyNot:["Invertido.","","No aplica.","No es cap rate."] },
  { q:"Referidores externos (no corredores):", opts:["No existen","Firman acuerdo externo previo","Operan informales","Prohibidos"], correct:1, why:"Vía formal.", whyNot:["Existen.","","Informal no aplica.","No prohibidos."] },
  { q:"Notas en CRM:", opts:["Solo emojis","Fecha + interacción + próximo paso","Secretas","Borrar"], correct:1, why:"Trazabilidad = derechos.", whyNot:["Insuficiente.","","Contradice rol.","Pierde historial."] },
  { q:"Un WhatsApp masivo a tu red:", opts:["Óptimo","Quema la lista; mejor 1-a-1","Lo exige TuMatch","Obligatorio"], correct:1, why:"Masivos bajan conversión.", whyNot:["Al revés.","","No lo exige.","No es obligatorio."] },
  { q:"Certificado del onboarding acredita:", opts:["Corredor","Captador TuMatch certificado","Socio fundador","Gerente"], correct:1, why:"Rol específico acreditado.", whyNot:["Exige estudios más largos.","","Rol societario.","No aplica."] },
  { q:"TL aporta al captador:", opts:["Nada","Guía de zonas, coaching, revisión de acuerdos y equipo que ejecuta tus captaciones","Competencia","Sueldo fijo"], correct:1, why:"El TL es aliado: te convierte captaciones en cierres gracias a su equipo.", whyNot:["Aporte sustancial.","","Son socios, no rivales.","No hay sueldo; modelo de comisión."] },
  { q:"Rol del captador ideal:", opts:["Miedo a hablar","Red amplia + escucha activa","Solo capital","Título universitario"], correct:1, why:"Red + escucha = detectar oportunidades.", whyNot:["Incompatible.","","No exige capital.","No exige título."] },
  { q:"Si eres empleado full-time y quieres captar:", opts:["Prohibido","Permitido y promovido part-time","Renunciar","Membresía cara"], correct:1, why:"Modelo flexible.", whyNot:["Permitido.","","No obliga.","Sin membresía costosa."] },
  { q:"Captador que quiere ejecutar gestión:", opts:["No puede","Capacitarse como corredor freelance (acumula roles)","Familiar del TL","20 años exp."], correct:1, why:"Roles acumulables.", whyNot:["Puede.","","No aplica.","No aplica."] },
  { q:"Marca TuMatch exige:", opts:["Descuido","Profesionalismo visual, lenguaje y uso correcto de logos","Marcas propias","Imitar competencia"], correct:1, why:"Coherencia = diferencia.", whyNot:["Dañina.","","Confunde.","Ni original ni funcional."] },
  { q:"Si piden servicio fuera del core:", opts:["Mentir","Derivar a partner; mantener relación","Cobrar por intento","Ignorar"], correct:1, why:"Honestidad construye.", whyNot:["Destruye reputación.","","Abusivo.","Aleja."] },
  { q:"Subir acuerdo firmado al CRM:", opts:["Opcional","Obligatorio para gatillar el 5% extra","Por correo","Por WhatsApp"], correct:1, why:"Sin registro, sin derecho.", whyNot:["Obligatorio.","","Insuficiente.","Insuficiente."] },
  { q:"Rol del captador en TuMatch:", opts:["Secundario","Estratégico: motor del negocio","Opcional","Admin"], correct:1, why:"Sin captación no hay stock.", whyNot:["Esencial.","","No opcional.","No administrativo."] },
  { q:"Meta realista mes 1 de captador:", opts:["100 clientes","10 reuniones reales + 2 acuerdos firmados","5 ventas","$3 M"], correct:1, why:"Foco en actividad y formalización.", whyNot:["Irreal.","","Prematuro.","No es el foco."] },
  { q:"Fecha de corte para esquema 2026:", opts:["1-ene-2026","31-dic-2025","Cualquier día","No hay"], correct:0, why:"Aplica a operaciones posteriores a esa fecha.", whyNot:["","Año anterior.","Debe haber corte.","Sí hay corte."] },
  { q:"Un lead duplicado en CRM:", opts:["Paga doble","Se fusiona manteniendo historial","Se borra uno","Se compra"], correct:1, why:"Protege trazabilidad del primer registro.", whyNot:["No corresponde.","","Pierde historial.","No aplica."] },
  { q:"Medir salud del captador:", opts:["Solo ingreso","Actividad + conversión + red + CRM + cierres","Edad","Redes"], correct:1, why:"Métricas compuestas reflejan realidad.", whyNot:["Incompleto.","","Irrelevante.","Vanity."] }
];
